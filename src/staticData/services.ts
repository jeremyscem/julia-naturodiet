...
export const services:ServicesType[] = [{
    "isPrincipal": true,
    "name": "Programme Autonome",
    "title": "Prenez les Rênes de Votre Alimentation",
    "description": "Recevez un programme nutritionnel personnalisé avec un menu adapté et gérez votre rééquilibrage en toute autonomie pendant un mois.",
